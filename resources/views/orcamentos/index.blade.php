      ...
      <!-- FILTRO DE PESQUISA -->
        ...
        <div class="col-11 container ">
            ...
            <table class="table table-striped table-dark text-center">
                ...
                <tbody>
                  <!-- LOOP PARA MOSTRAR TODOS OS ORÇAMENTOS QUE ESTAVAM NO BANCO E FORAM PASSADOS PELO COMPACT NA FUNÇÃO INDEX DO CONTROLLER -->
                    @foreach ($orcamentos as $item)
                        <tr>
                            ...
                            <td>
                              <!-- BOTÃO QUE REDIRECIONA PARA A PÁGINA EDITAR -->
                                ...
                                <a class="js-del" href="{{ url("orcamentos/delete/$item->id") }}">
